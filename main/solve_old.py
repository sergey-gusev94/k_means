...
def save_results(
    ...
    model_params = {
        ...
        "coord_range": (model.coord_range_lower, model.coord_range_upper),
    }
    ...
    if result.solver.termination_condition == pyo.TerminationCondition.optimal:
        ...
        x_values = {
            str(i): pyo.value(model.center_coordinates[i, j])
        ...
        try:
            ...
            x_values = {str(i): pyo.value(model.center_coordinates[i]) for i in model.clusters}
            objective_value = pyo.value(model.obj)
...
if __name__ == "__main__":
    ...
    path = os.path.join(
        os.path.dirname(os.getcwd()), "data", "models", "model_no_mode_2025-06-29_20-38-46.pkl"
    )
